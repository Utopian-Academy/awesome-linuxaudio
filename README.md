...
- [Software](#software)
    ...
    - [Effects/Processing - Collections](#effectsprocessing---collections)
    - [Effects/Processing - EQ](#effectsprocessing---eq)
    - [Effects/Processing - Other](#effectsprocessing---other)
    ...
    - [Media players - Graphical interfaces](#media-players---graphical-interfaces)
    - [Media players - Command-line interfaces/TUI](#media-players---command-line-interfacestui)
...
### Effects/Processing - Collections
...
_See also [Linux4VJs VJ tools](http://linux4vjs.net/list-of-linux-tools/)_
